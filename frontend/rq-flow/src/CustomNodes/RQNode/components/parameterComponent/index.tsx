...
export default function ParameterComponent({
	...
	const { generatePersonaFromRQ, currentNode } = useContext(contextMenuContext);
	...
	return (
		...
		>
			<>
				...
				{data.type === "RQNode" && title !== "research question" ? (
					<></>
					) : (
					...
					<>
						{!left && selected ? 
							<div className="flex items-center justify-end gap-4 text-xxl w-full text-end">
								...
								<Tooltip title={
									"Generate Personas: suggest expert personas to provide feedback based on this research question"
								}>
										<Button
											onClick={(event) => {
												...
												generatePersonaFromRQ(currentNode).finally(() => {
						...
						<Tooltip title={
							...
							"Connect this node to a persona node"
						}>
							<Handle
							...
							data.type === "RQNode" ?
								<div>
									...
									{data.value ?
										...
										(<h3>Type in your research ideas or questions:</h3>)
									}
									<TextAreaComponent
										disabled={disabled}
