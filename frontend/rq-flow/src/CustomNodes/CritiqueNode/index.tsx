...
export default function CritiqueNode({
  data,
  selected,
}: {
  data: NodeDataType
  ...
  const likertConfigs = {
    items: [
      {
        question: "This critique is relevant.",
        tag: "relevance",
      },
      {
        question: "This critique is helpful.",
        tag: "helpfulness",
      },
      {
        question:
          "This critique contains a lot of information to help me improve my research idea.",
        tag: "informativeness",
      },
      {
        question:
          "This critique provides me with new insights that I had not considered before.",
        tag: "insightfulness",
      },
    ],
    responses: [
  ...
  useEffect(() => {
    ...
    if (
      data.node.template.critique_aspect?.value &&
      data.node.template.critique_detail?.value
    ) {
      setValidationStatus("success")
    } else {
  ...
  const childComponent = (
    ...
    >
      ...
      <div className="shrink-0 rounded-lg border-sky-900 bg-[#FDA36F] px-5 py-5 shadow-xl">
        <div className="flex w-3/4 items-center gap-2 text-2xl">
          <Icon
          ...
          />
          <div className="font-bold overflow-hidden break-words">
            {data.node?.template["critique_aspect"].value
              ? data.node?.template["critique_aspect"].value
              : "Custom Critique"}
          </div>
      ...
      console.log("image loaded");
        ...
        Output
          ...
          <div>
            ...
            {data.node.template["critique_aspect"].value ? (
              <>
                {/* <div className="text-xl font-bold">Aspect of Critique: </div> */}
                <div className="line-clamp-3">
                  {data.node.template["critique_detail"].value}
                </div>
                <div className="mt-4 text-md font-bold">Click to view more</div>
              </>
            ) : (
              ""
            )}
  ...
  return isInteractiveTutorialOpen && currentStep < 11 ? (
    <InteractiveTutorialComponent childNodeId={data.id}>
      {childComponent}
