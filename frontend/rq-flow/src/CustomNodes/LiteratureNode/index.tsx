...
import { Textarea, Button, IconButton, Card } from "@material-tailwind/react"
...
export default function LiteratureNode({
  data,
  selected,
}: {
  data: NodeDataType
  ...
  const likertConfigs = {
    items: [
      {
        question: "These literature are relevant.",
        tag: "relevance",
      },
      {
        question: "These literature are helpful.",
        tag: "helpfulness",
      },
      {
        question: "These literature are creative.",
        tag: "creativity",
      },
    ],
    responses: [
  ...
  useEffect(() => {
    ...
    if (data.node.template.paper_list?.value) {
      setValidationStatus("success")
    } else {
  ...
  useEffect(() => {}, [data?.node.template.paper_list.value, selected])
  ...
  const childComponent = (
    ...
    >
      ...
      <div className="nowheel shrink-0 rounded-lg border-sky-900 bg-[#BBFBC5] px-5 py-5 shadow-xl">
      ...
      console.log("image loaded");
        ...
        {false ? (
          ...
          <div>
            ...
            {
              <div className="text-xxl mt-1 w-full px-5 py-2 dark:text-black">
                {data.node.template["paper_list"].name ? (
            ...
            {data.node.template["paper_list"].value ? (
                  ...
                  .map((paper, idx) => (
                    <div key={idx}>
                      <Card className="m-4 flex">
                        <div className="m-3 text-base font-bold">
                          {paper.title}
                        </div>
  ...
  return isInteractiveTutorialOpen && (currentStep < 7 || currentStep === 8) ? (
    <InteractiveTutorialComponent targetTutorialStep={6} childNodeId={data.id}>
      {childComponent}
